...
// rooted at a .loom directory. Layout:
//
//	.loom/
...
// formatMarker is written to .loom/format. It pins the repository layout
// version; the object format itself is self-describing and frozen separately.
const formatMarker = "loom repository format 1\n"

// ErrNotRepo is returned when no repository is found.
var ErrNotRepo = errors.New("repo: not a loom repository (no .loom directory found)")
...
// Root returns the working-tree root (the parent of .loom).
func (r *Repo) Root() string { return r.root }

// GitDir returns the path to the .loom metadata directory.

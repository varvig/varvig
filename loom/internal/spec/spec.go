// Package spec is Loom's speculation store (design §1.5). Branching becomes
...
//
// A candidate is one file under .loom/spec/<task>/<change-hex>, so concurrent
...
// Pool is a speculation store rooted at .loom/spec.

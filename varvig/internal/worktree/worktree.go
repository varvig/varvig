// Package worktree materializes Varvig objects to a plain working tree on a real
...
// files, symlinks, and nested directories are supported; the .varvig directory

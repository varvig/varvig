...
// environment (VARVIG_MODEL, VARVIG_MODEL_VERSION, VARVIG_SAMPLING, VARVIG_TOOL_PERMS,
// VARVIG_TASK, VARVIG_CONTEXT, VARVIG_REASONING), and the tool binary's own hash.
func Build(authority string) object.Provenance {
	return object.Provenance{
		Authority:       authority,
		Model:           os.Getenv("VARVIG_MODEL"),
		ModelVersion:    os.Getenv("VARVIG_MODEL_VERSION"),
		Sampling:        os.Getenv("VARVIG_SAMPLING"),
		ToolPermissions: splitList(os.Getenv("VARVIG_TOOL_PERMS")),
		ToolHash:        hashSelf(),
		TaskSpec:        os.Getenv("VARVIG_TASK"),
		ContextRead:     os.Getenv("VARVIG_CONTEXT"),
		Reasoning:       os.Getenv("VARVIG_REASONING"),
	}
}
